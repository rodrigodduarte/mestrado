...
def train_model(config=None):
    ...
    with wandb.init(project="swedish_swint_s_224", config=config):
        ...
        wandb_logger = WandbLogger(project="swedish_swint_s_224")
...
if __name__ == "__main__":
    ...
    sweep_id = wandb.sweep(sweep_config, project="swedish_swint_s_224")
