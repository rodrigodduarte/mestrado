...
def train_model(config=None):
    ...
    with wandb.init(project="swedish_cct_224", config=config):
        ...
        wandb_logger = WandbLogger(project="swedish_cct_224")
...
if __name__ == "__main__":
    ...
    sweep_config = {
        ...
        'parameters': {
            'batch_size': {
                'values': [32, 64]  # valores de batch size a serem testados
            },
            'learning_rate': {
    ...
    sweep_id = wandb.sweep(sweep_config, project="swedish_cct_224")

    # Executar o sweep
    wandb.agent(sweep_id, function=train_model, count=30)  # Executa o sweep com 10 variações
