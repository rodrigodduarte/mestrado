...
caminho_diretorio_original = os.path.expanduser('~/Documentos/projeto/imagens/soja1')
caminho_diretorio_novo = os.path.expanduser('~/Documentos/projeto/imagens/soja')
